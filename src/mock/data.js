...
export const aboutData = {
  ...
  paragraphThree: 'I became fluent in Javascript by using the React, Redux framworks as well as Postgres and Node for backend development. Below are just a few of the things I work on in my free time. I would love to take theses skills and bring them to a company to help do some real good in the world and help a lot of people.',
  resume: 'https://drive.google.com/open?id=1_sBxxmFFwI4WrjNfJc09vx6QIjcFUTPI', // if no resume, the button will not show up
};
